...
class ThreadListener extends Thread {
    ...
    private final Vector<ConnectionThread> connectionThreads;
    private final Vector<ConnectionThread> notRunningConnectionThreads;
    private boolean isRunning;

    public ThreadListener(SocketServer socketServer, ServerSocket serverSocket) {
